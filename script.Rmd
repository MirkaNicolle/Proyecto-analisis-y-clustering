...
<!-- ```{r CREACION DE TABLA PARA SVM} -->
<!-- #library(dplyr) -->
<!-- set.seed(123) -->

<!-- #EDAD2012 <- X20122[,c("EDADMUJ", "CLAUNI", "GETMUJ")] -->
<!-- EDAD2013 <- X2013[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2014 <- X2014[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2015 <- X2015[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2016 <- X2016[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2017 <- X2017[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2018 <- X2018[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->
<!-- EDAD2019 <- X2019[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM")] -->

<!-- EDADESMATRI <- rbind(EDAD2013,EDAD2014,EDAD2015,EDAD2016,EDAD2017,EDAD2018,EDAD2019) -->
<!-- EDADESMATRI$clasificacion <- ifelse(EDADESMATRI$EDADMUJ <= 17, 0, ifelse(EDADESMATRI$EDADMUJ >= 18, 1,NA)) -->

<!-- #select(EDADESMATRI, -c(EDADMUJ)) -->

<!-- ``` -->



# ```{r SVM Clasificacion Matrimonio}
# library(e1071)
# 
# set.seed(123)
# porciento <- 70/100
# 
# trainSVMMatrimonioRowsNumber<-sample(1:nrow(EDADESMATRI),porciento*nrow(EDADESMATRI))
# trainSVM_matrimonio<-EDADESMATRI[trainSVMMatrimonioRowsNumber,]
# testSVM_Matrimonio<-EDADESMATRI[-trainSVMMatrimonioRowsNumber,]
# 
# modelo_Matrimonio_L <- svm(clasificacion~., data=trainSVM_matrimonio,type="C-classification", cost=0.1, gamma=0.1,  kernel="linear")
# #modelo_Matrimonio_R <- svm(clasificacion~., data=trainSVM_matrimonio,type="C-classification", gamma=0.5, kernel="radial")
# #modelo_Matrimonio_P <- svm(clasificacion~., data=trainSVM_matrimonio,type="C-classification", gamma=0.5, kernel="linear", coef0=1)
# 
# summary(modelo_Matrimonio_L)
# 
# ```
...
# ```{r MATRIZ DE CONFUSION SVM }
# library(caret)
# testSVM_Matrimonio$clasificacion<- as.factor(testSVM_Matrimonio$clasificacion)
# prediccion_SVM_Matrimonio <- predict(modelo_Matrimonio_L, newdata = testSVM_Matrimonio[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM", "PUEHOM", "ESCHOM","clasificacion")])
# cm_SVM_Matrimonio <- confusionMatrix(testSVM_Matrimonio$clasificacion, prediccion_SVM_Matrimonio)
# cm_SVM_Matrimonio
# 
# ```
