...
barplot(counts, las = 2, cex.names=.8 ,main = "Distribución de etnia de los hombres", xlab = "Etnia del hombre")
```
...
barplot(counts, las = 2, cex.names=.8 ,main = "Distribución de etnia de las mujeres", xlab = "Etnia de las mujeres")
```
...
barplot(counts, las = 2, cex.names=.6 ,main = "Departamentos con matrimonios con menores de edad", xlab = "Departamentos de ocurrencia")
```
...
barplot(counts, las = 2, cex.names=.8 ,main = "Etnia de mujeres involucradas en matrimonios con menores de edad", xlab = "Etnia de las mujeres")
```
...
barplot(counts, las = 2, cex.names=.8 ,main = "Etnia de hombres involucrados en matrimonios con menores de edad", xlab = "Etnia de los hombres")
```
