...
EDAD2013 <- X2013[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2014 <- X2014[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2015 <- X2015[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2016 <- X2016[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2017 <- X2017[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2018 <- X2018[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
EDAD2019 <- X2019[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM")]
...
modelo_Matrimonio_L <- svm(clasificacion~., data=trainSVM_matrimonio,type="C-classification", cost=0.5, kernel="linear")
...
prediccion_SVM_Matrimonio <- predict(modelo_Matrimonio_L, newdata = testSVM_Matrimonio[,c("EDADMUJ", "PUEMUJ", "DEPREG", "ESCMUJ", "EDADHOM","clasificacion")])
