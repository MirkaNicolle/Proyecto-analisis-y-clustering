...
```{r}
datosMatrimonio$`Escolaridad de la mujer`
edadPareja<-subset(datosMatrimonio, select=c('Edad del hombre','Edad de la mujer','Escolaridad del hombre','Escolaridad de la mujer'),datosMatrimonio$`Edad de la mujer`!=999 & datosMatrimonio$`Edad del hombre`!=999)
